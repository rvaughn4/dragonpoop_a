...
namespace dp
{
    ...
    //add mouse event
    void dpinput_writelock::addMouseEvent( float x, float y, float sx, float sy, float w, float h, bool bIsRight, bool bIsDown )
    {
        this->p->addMouseEvent( x, y, sx, sy, w, h, bIsRight, bIsDown );
    }
