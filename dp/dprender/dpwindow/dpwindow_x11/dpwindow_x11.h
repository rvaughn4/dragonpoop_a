...
#ifndef dpwindow_x11_h
#define dpwindow_x11_h
...
namespace dp
{
    ...
    class dpwindow_x11 : public dpwindow
    {
    ...
    public:
        ...
        //ctor
        dpwindow_x11( unsigned int w, unsigned int h, const char *cname );
        //dtor
        virtual ~dpwindow_x11( void );

        friend class dpwindow_x11_writelock;
        friend class dpwindow_x11_readlock;
    };
