...
namespace dp
{
    ...
    //ctor
    dpapi_opengl1o5_context_readlock::dpapi_opengl1o5_context_readlock( dpapi_opengl1o5_context *p, dpmutex_readlock *ml ) : dpapi_context_readlock( p, ml )
    {
        this->p = p;
    }

    //dtor
    dpapi_opengl1o5_context_readlock::~dpapi_opengl1o5_context_readlock( void )
    {
