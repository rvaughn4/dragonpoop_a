...
#else
    #define dpshared_guard_tryReadLock( x, y ) x._usemacro_tryReadLock( y )
    #define dpshared_guard_tryWriteLock( x, y ) x._usemacro_tryWriteLock( y )
    #define dpshared_guard_tryReadLock_timeout( x, y, timeout_ms ) x._usemacro_tryReadLock( y, timeout_ms )
    #define dpshared_guard_tryWriteLock_timeout( x, y, timeout_ms ) x._usemacro_tryWriteLock( y, timeout_ms )
    #define dpshared_guard_readLock_block( x, y ) x._usemacro_readLock( y )
    #define dpshared_guard_writeLock_block( x, y ) x._usemacro_writeLock( y )
#endif
